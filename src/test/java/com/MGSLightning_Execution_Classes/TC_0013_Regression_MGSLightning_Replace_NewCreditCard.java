...
public class TC_0013_Regression_MGSLightning_Replace_NewCreditCard {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0013_Regression_MGSLightning_Replace_NewCreditCard.html";
	...
	@Test
	public static void TC_0013_Regression_MGSLightning_Replace_NewCreditCard()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningValidateWCMemberDetails_replaceNewCreditCard();
