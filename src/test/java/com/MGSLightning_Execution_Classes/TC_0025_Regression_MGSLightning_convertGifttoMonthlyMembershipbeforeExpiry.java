...
public class TC_0025_Regression_MGSLightning_convertGifttoMonthlyMembershipbeforeExpiry {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0025_Regression_MGSLightning_convertGifttoMonthlyMembershipbeforeExpiry.html";
		CurrentPageTestCaseName = "TC_0025_Regression_MGSClassic_convertGifttoMonthlyMembershipbeforeExpiry";
	...
	@Test
	public static void TC_0025_Regression_MGSLightning_convertGifttoMonthlyMembershipbeforeExpiry()
		...
		for (int row = 1; row < GiftMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_convertGiftMembershiptoMonthlybeforeExpirationDate();
