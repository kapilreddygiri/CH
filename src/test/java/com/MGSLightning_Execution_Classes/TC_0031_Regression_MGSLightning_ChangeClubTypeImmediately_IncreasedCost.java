...
public class TC_0031_Regression_MGSLightning_ChangeClubTypeImmediately_IncreasedCost {
	...
	public static void TC_0031_Regression_MGSClassic_ChangeClubTypeImmediately_IncreasedCost()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_changeclubTypeImmediatelyIncreasedCost();
