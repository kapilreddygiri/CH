...
public class TC_0035_Regression_MGSLightning_Change2to1BottleMembership_NextBillingCycle {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0035_Regression_MGSClassic_Change2to1BottleMembership_NextBillingCycle.html";
	...
	public static void TC_0035_Regression_MGSClassic_Change2to1BottleMembership_NextBillingCycle()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_change2to1BottlesNextBillingCycle(row);
