...
public class TC_0041_Regression_MGSLightning_Update_ContactInformation {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0041_Regression_MGSClassic_Update_ContactInformation.html";
	...
	public static void TC_0041_Regression_MGSClassic_Update_ContactInformation()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_updateContactInformation(row);
