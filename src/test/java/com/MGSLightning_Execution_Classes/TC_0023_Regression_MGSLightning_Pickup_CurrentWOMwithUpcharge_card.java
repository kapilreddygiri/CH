...
public class TC_0023_Regression_MGSLightning_Pickup_CurrentWOMwithUpcharge_card {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0023_Regression_MGS_Pickup_CurrentWOMwithUpcharge_card.html";
		CurrentPageTestCaseName = "TC_0021_Regression_MGS_Pickup_priorWOMwithNoupcharge_card";
	...
	@Test
	public static void TC_0024_Regression_MGS_Pickup_CurrentWOMwithUpcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_SelectWCCurrentWOMPickUPwithCharge(row);
