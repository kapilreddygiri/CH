...
public class TC_0036_Regression_MGSLightning_Replace_PersonalizedWCCard {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0036_Regression_MGSLightning_Replace_PersonalizedWCCard.html";
		CurrentPageTestCaseName = "TC_0036_Regression_MGSLightning_Replace_PersonalizedWCCard";
	...
	@Test
	public static void TC_0036_Regression_MGSLightning_Replace_PersonalizedWCCard()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_replacePersonalizedWCCard(row);
