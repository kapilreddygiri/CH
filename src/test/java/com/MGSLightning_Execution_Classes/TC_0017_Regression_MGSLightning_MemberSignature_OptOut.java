...
public class TC_0017_Regression_MGSLightning_MemberSignature_OptOut {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0017_Regression_MGSLightning_MemberSignature_OptOut.html";
		CurrentPageTestCaseName = "TC_0017_Regression_MGSLightning_MemberSignature_OptOut";
	...
	@Test
	public static void TC_0017_Regression_MGSLightning_MemberSignature_OptOut()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_MemberSignatureCheckedOPtOut();
