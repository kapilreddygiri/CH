...
public class TC_0027_Regression_MGSLightning_ChangeDeliveryNextBillingCycle {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0027_Regression_MGSLightning_ChangeDeliveryNextBillingCycle.html";
		CurrentPageTestCaseName = "TC_0027_Regression_MGSLightning_ChangeDeliveryNextBillingCycle";
	...
	@Test
	public static void TC_0027_Regression_MGSLightning_ChangeDeliveryNextBillingCycle()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_changeDeliveryNextBillingCycle();
