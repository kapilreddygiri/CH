...
public class TC_0022_Regression_MGSLightning_Pickup_priorWOMwithUpcharge_card {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0022_Regression_MGS_Pickup_priorWOMwithUpcharge_card.html";
	...
	@Test
	public static void TC_0023_Regression_MGS_Pickup_priorWOMwithUpcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_SelectWCPriorWOMPickUPwithCharge(row);
				Thread.sleep(5000);
