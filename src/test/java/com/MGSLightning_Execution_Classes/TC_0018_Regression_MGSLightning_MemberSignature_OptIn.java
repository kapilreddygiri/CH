...
public class TC_0018_Regression_MGSLightning_MemberSignature_OptIn {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0018_Regression_MGS_MemberSignature_OptIn.html";
	...
	public static void TC_0018_Regression_MGS_MemberSignature_OptIn()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_MemberSignatureCheckedOPtIn();
