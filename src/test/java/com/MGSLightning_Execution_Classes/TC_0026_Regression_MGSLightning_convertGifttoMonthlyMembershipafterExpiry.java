...
public class TC_0026_Regression_MGSLightning_convertGifttoMonthlyMembershipafterExpiry {
	...
	public static void TC_0026_Regression_MGSClassic_convertGifttoMonthlyMembershipafterExpiry()
		...
		for (int row = 1; row < GiftMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_convertGiftMembershiptoMonthlyafterExpirationDate( );
