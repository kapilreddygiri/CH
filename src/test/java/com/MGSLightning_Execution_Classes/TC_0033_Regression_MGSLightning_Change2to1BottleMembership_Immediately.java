...
public class TC_0033_Regression_MGSLightning_Change2to1BottleMembership_Immediately {
	...
	public static void TC_0033_Regression_MGSClassic_Change2to1BottleMembership_Immediately()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_change2to1BottlesImmediately(row);
