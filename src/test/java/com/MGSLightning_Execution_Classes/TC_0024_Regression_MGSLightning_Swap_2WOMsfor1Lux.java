...
public class TC_0024_Regression_MGSLightning_Swap_2WOMsfor1Lux {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0024_Regression_MGS_Swap_2WOMsfor1Lux.html";
		CurrentPageTestCaseName = "TC_0024_Regression_MGS_Swap_2WOMsfor1Lux";
	...
	@Test
	public static void TC_0024_Regression_MGS_Swap_2WOMsfor1Lux()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_swap2WOMSfor1Lux();
