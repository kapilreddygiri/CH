...
public class TC_0032_Regression_MGSLightning_Change1to2BottleMembership_Immediately {
	...
	public static void TC_0032_Regression_MGSClassic_Change1to2BottleMembership_Immediately()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_change1to2BottlesImmediately(row);
