...
public class TC_0038_Regression_MGSLightning_Cancel_Membership {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0038_Regression_MGSClassic_Cancel_Membership.html";
	...
	public static void TC_0038_Regression_MGSClassic_Cancel_Membership()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_cancelMembership();
