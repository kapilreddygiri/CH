...
public class TC_0015_Regression_MGSLightning_Markoff_Tasting {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0015_Regression_MGS_Markoff_Tasting.html";
	...
	@Test
	public static void TC_0015_Regression_MGS_Markoff_Tasting()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_markOffTasting();
