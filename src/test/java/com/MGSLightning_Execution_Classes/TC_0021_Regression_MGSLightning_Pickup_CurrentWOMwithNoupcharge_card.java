...
public class TC_0021_Regression_MGSLightning_Pickup_CurrentWOMwithNoupcharge_card {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0021_Regression_MGS_Pickup_priorWOMwithNoupcharge_card.html";
	...
	@Test
	public static void TC_0021_Regression_MGS_Pickup_CurrentWOMwithNoupcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_SelectWCCurrentWOMPickUP();
