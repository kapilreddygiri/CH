...
public class TC_0020_Regression_MGSLightning_Pickup_priorWOMwithNoupcharge_card {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0020_Regression_MGS_Pickup_priorWOMwithNoupcharge_card.html";
		CurrentPageTestCaseName = "TC_0020_Regression_MGSLightning_Pickup_priorWOMwithNoupcharge_card";
	...
	@Test
	public static void TC_0020_Regression_MGSLightning_Pickup_priorWOMwithNoupcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_SelectWCPriorWOMPickUP();
