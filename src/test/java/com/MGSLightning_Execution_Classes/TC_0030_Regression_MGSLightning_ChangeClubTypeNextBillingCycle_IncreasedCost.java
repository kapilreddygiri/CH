...
public class TC_0030_Regression_MGSLightning_ChangeClubTypeNextBillingCycle_IncreasedCost {
	...
	@Test
	public static void TC_0030_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_IncreasedCost()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_changeclubTypeNextBillingCycleIncreasedCost(row);
