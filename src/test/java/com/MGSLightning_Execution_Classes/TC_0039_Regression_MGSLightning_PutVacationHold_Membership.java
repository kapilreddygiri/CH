...
public class TC_0039_Regression_MGSLightning_PutVacationHold_Membership {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0039_Regression_MGSLightning_PutVacationHold_Membership.html";
		CurrentPageTestCaseName = "TC_0039_Regression_MGSLightning_PutVacationHold_Membership";
	...
	@Test
	public static void TC_0039_Regression_MGSLightning_PutVacationHold_Membership()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.LightningWCMemberValidationPage_putVacationHold();
