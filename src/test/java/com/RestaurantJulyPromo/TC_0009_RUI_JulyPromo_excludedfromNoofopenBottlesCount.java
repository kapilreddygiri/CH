...
public class TC_0009_RUI_JulyPromo_excludedfromNoofopenBottlesCount {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0008_RUI_JulyPromo_excludedfromAmbassadorTenure.html";
		CurrentPageTestCaseName = "Ambassador points are not calculated for July Promo bottles";
	...
	@Test
	public static void TC_0008_RUI_JulyPromo_excludedfromAmbassadorTenure()
		...
		for (int row = 1; row < RestaurantMonthlyMemberData.GetRows(); row++) {
			...
			try {
					...
					Restaurant_Common_Pages.Page_WinePickUp_bottlesAvailableIncludedinTotalBottles();
