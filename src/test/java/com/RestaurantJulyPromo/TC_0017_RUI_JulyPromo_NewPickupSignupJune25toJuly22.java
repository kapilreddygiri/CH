...
public class TC_0017_RUI_JulyPromo_NewPickupSignupJune25toJuly22 {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0017_RUI_JulyPromo_NewPickupSignupJune25toJuly22.html";
		CurrentPageTestCaseName = " July Promo New Pickup Signup from June25 to July22";
		ExcelSheetPath ="C:\\Users\\kgiri\\Documents\\GitHub\\Test-Automation\\com.CoopersHawkAutomation\\Resources\\TestData\\Restaurant_TestData.xls";
	...
	@Test
	public static void TC_0017_RUI_JulyPromo_NewPickupSignupJune25toJuly22()
		...
		for (int row = 2; row < RestaurantMonthlyMemberData.GetRows(); row++) {
			if (RestaurantMonthlyMemberData.Getdata("WC Member Record Type", row).trim().length() > 2) {
				try {
					...
					Restaurant_Common_Pages.Page_WinePickUp_JulyPromoEligibilityforNewPickUpTypeSignUpJune25toJuly22(row );
					

//					Restaurant_Common_Pages.CMUPage_Menu_ClickLogout(row);
