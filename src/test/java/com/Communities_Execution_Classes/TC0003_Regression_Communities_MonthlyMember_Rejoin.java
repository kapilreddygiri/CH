...
public class TC0003_Regression_Communities_MonthlyMember_Rejoin {
	...
	public static void Beforetest() throws IOException, BiffException {
		...
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC0003_Regression_Communities_MonthlyMember_Rejoin.html";
		CurrentPageTestCaseName = "TC0003_Regression_Communities_MonthlyMember_Rejoin";
	...
	@Test
	public static void TC0003_Regression_Communities_MonthlyMember_Rejoin()
...
// WE SHOULD ADD A CANCELLED CARD BY HARD CODE TO FIRST ROW IN TEST DATA OR LOOP IT N SEARCH FOR A CANCELLED CARD
					CommunitiesPages.CMUPage_Login_LaunchURL();
					CommunitiesPages.CMUPage_Login_SignIn(row);
					CommunitiesPages.CMUPage_Dashboard_rejoinMembership();
