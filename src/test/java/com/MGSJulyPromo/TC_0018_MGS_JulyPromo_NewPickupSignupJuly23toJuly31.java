...
public class TC_0018_MGS_JulyPromo_NewPickupSignupJuly23toJuly31 {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0018_MGS_JulyPromo_NewPickupSignupJuly23toJuly31.html";
		CurrentPageTestCaseName = "TC_0018_MGS_JulyPromo_NewPickupSignupJuly23toJuly31";
	...
	@Test
	public static void TC_0018_MGS_JulyPromo_NewPickupSignupJuly23toJuly31()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_JulyPromoEligibilityforNewPickUpTypeSignUpJuly23toJuly31(row);
