...
public class TC_0020_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJuly23toJuly31 {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0020_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJuly23toJuly31.html";
		CurrentPageTestCaseName = "TC_0020_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJuly23toJuly31";
	...
	@Test
	public static void TC_0020_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJuly23toJuly31()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_JulyPromoEligibilityforNewNonPayeeMemberSignUpJuneJuly23toJuly31(row);
