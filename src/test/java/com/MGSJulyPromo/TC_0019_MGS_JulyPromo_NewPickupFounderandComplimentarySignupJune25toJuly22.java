...
public class TC_0019_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJune25toJuly22 {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0019_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJune25toJuly22.html";
		CurrentPageTestCaseName = "TC_0019_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJune25toJuly22";
	...
	@Test
	public static void TC_0019_MGS_JulyPromo_NewPickupFounderandComplimentarySignupJune25toJuly22()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_JulyPromoEligibilityforNewNonPayeeMemberSignUpJune25toJuly22(row);
