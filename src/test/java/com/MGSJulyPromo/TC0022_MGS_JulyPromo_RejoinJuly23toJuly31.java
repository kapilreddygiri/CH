...
public class TC0022_MGS_JulyPromo_RejoinJuly23toJuly31 {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC0022_MGS_JulyPromo_RejoinJuly23toJuly31.html";
		CurrentPageTestCaseName = "TC0022_MGS_JulyPromo_RejoinJuly23toJuly31";
	...
	@Test
	public static void TC0022_MGS_JulyPromo_RejoinJuly23toJuly31()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_rejoinMember(row);
