...
public class TC_0009_MGS_JulyPromo_excludedfromNoofopenBottlesCount {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0009_MGS_JulyPromo_excludedfromNoofopenBottlesCount.html";
		CurrentPageTestCaseName = "July Promo count excluded from no of open bottles count";
	...
	@Test
	public static void TC_0009_MGS_JulyPromo_excludedfromNoofopenBottlesCount()
