...
public class TC_0084_Regression_RUI_Changefrom1to2bottlemembershipImmediatelywithBARTENDER {
	...
	public static void BeforeTest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0084_Regression_RUI_Changefrom1to2bottlemembershipImmediatelywithBARTENDER.html";
		CurrentPageTestCaseName = "Change from 1 to 2 bottle membership Immediately with BARTENDER";
	...
	@Test
	public static void TC_0084_Regression_RUI_Changefrom1to2bottlemembershipImmediatelywithBARTENDER()
