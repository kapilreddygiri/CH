...
public class TC_0025_Regression_RUI_AddNoteswithSERVER {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0025_Regression_RUI_AddNoteswithSERVER.html";
		CurrentPageTestCaseName = "Add Notes with SERVER";
	...
	@Test
	public static void TC_0025_Regression_RUI_AddNoteswithSERVER()
