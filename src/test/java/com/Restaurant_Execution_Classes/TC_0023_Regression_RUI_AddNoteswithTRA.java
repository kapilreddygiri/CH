...
public class TC_0023_Regression_RUI_AddNoteswithTRA {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0023_Regression_RUI_AddNoteswithTRA.html";
		CurrentPageTestCaseName = "Add Notes with TRA";
	...
	@Test
	public static void TC_0023_Regression_RUI_AddNoteswithTRA()
