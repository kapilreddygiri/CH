...
public class TC_0091_Regression_RUI_Changefrom1to2bottlemembershipNextBillingCyclewithTRA  {
	...
	public static void BeforeTest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0091_Regression_RUI_Changefrom1to2bottlemembershipNextBillingCyclewithTRA .html";
		CurrentPageTestCaseName = "Change from 1 to 2 bottle membership next billing cycle with TRA";
	...
	@Test
	public static void TC_0091_Regression_RUI_Changefrom1to2bottlemembershipNextBillingCyclewithTRA ()
