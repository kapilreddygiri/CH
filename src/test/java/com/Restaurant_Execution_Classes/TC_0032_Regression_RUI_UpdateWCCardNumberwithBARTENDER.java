...
public class TC_0032_Regression_RUI_UpdateWCCardNumberwithBARTENDER {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0032_Regression_RUI_UpdateWCCardNumberwithBARTENDER.html";
		CurrentPageTestCaseName = "Update WC Card Number with BARTENDER";
	...
	@Test
	public static void TC_0032_Regression_RUI_UpdateWCCardNumberwithBARTENDER()
