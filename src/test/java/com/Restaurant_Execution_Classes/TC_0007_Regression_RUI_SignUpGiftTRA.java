...
public class TC_0007_Regression_RUI_SignUpGiftTRA {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_007_Regression_RUI_SignUpGiftTRA.html";
	...
	@Test
	public static void TC_007_Regression_RUI_SignUpGiftTRA()
			throws IOException, InterruptedException, BiffException, WriteException {
		for (int row = 1; row < RestaurantGiftMemberData.GetRows(); row++) {
