...
public class TC_0077_Regression_RUI_ChangeClubtypeNextBillingcycleDecreasedcostwithSERVER {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0077_Regression_RUI_ChangeClubtypeNextBillingcycleDecreasedcostwithSERVER.html";
		CurrentPageTestCaseName = "Change Club type Next Billing cycle Decreased cost with SERVER";
	...
	@Test
	public static void TC_0077_Regression_RUI_ChangeClubtypeNextBillingcycleDecreasedcostwithSERVER()
