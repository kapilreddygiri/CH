...
public class TC_0093_Regression_RUI_Changefrom1to2bottlemembershipNextBillingCyclewithSERVER  {
	...
	public static void BeforeTest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0093_Regression_RUI_Changefrom1to2bottlemembershipNextBillingCyclewithSERVER.html";
		CurrentPageTestCaseName = "Change from 1 to 2 bottle membership Next Billing Cycle with SERVER";
	...
	@Test
	public static void TC_0093_Regression_RUI_Changefrom1to2bottlemembershipNextBillingCyclewithSERVER ()
