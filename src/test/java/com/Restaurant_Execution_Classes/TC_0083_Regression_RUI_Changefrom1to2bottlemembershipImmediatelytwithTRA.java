...
public class TC_0083_Regression_RUI_Changefrom1to2bottlemembershipImmediatelytwithTRA  {
	...
	public static void BeforeTest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0083_Regression_RUI_Changefrom1to2bottlemembershipImmediatelytwithTRA .html";
		CurrentPageTestCaseName = "Change from 1 to 2 bottle membership Immediately with TRA";
	...
	@Test
	public static void TC_0083_Regression_RUI_Changefrom1to2bottlemembershipImmediatelytwithTRA ()
