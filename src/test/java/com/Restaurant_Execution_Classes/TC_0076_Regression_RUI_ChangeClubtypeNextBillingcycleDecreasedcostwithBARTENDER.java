...
public class TC_0076_Regression_RUI_ChangeClubtypeNextBillingcycleDecreasedcostwithBARTENDER {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0076_Regression_RUI_ChangeClubtypeNextBillingcycleDecreasedcostwithBARTENDER.html";
		CurrentPageTestCaseName = "Change Club type Next Billing cycle Decreased cost with BARTENDER";
	...
	@Test
	public static void TC_0076_Regression_RUI_ChangeClubtypeNextBillingcycleDecreasedcostwithBARTENDER()
