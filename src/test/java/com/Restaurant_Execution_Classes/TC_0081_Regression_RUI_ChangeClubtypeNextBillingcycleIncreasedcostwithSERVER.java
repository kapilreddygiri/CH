...
public class TC_0081_Regression_RUI_ChangeClubtypeNextBillingcycleIncreasedcostwithSERVER {
	...
	public static void BeforeTest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0081_Regression_RUI_ChangeClubtypeNextBillingcycleIncreasedcostwithSERVER.html";
		CurrentPageTestCaseName = "Change Club type Next Billing cycle Increased cost with SERVER";
	...
	@Test
	public static void TC_0081_Regression_RUI_ChangeClubtypeNextBillingcycleIncreasedcostwithSERVER()
