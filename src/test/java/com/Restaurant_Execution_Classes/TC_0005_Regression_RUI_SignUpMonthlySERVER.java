...
public class TC_0005_Regression_RUI_SignUpMonthlySERVER {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_005_Regression_RUI_SignUpMonthlySERVER.html";
		CurrentPageTestCaseName = "Restaurant SignUp Monthly SERVER";
	...
	@Test
	public static void TC_005_Regression_RUI_SignUpMonthlySERVER()
