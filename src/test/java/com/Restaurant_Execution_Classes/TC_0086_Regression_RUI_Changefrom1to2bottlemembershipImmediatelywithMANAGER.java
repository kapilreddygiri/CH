...
public class TC_0086_Regression_RUI_Changefrom1to2bottlemembershipImmediatelywithMANAGER {
	...
	public static void BeforeTest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0086_Regression_RUI_Changefrom1to2bottlemembershipImmediatelywithMANAGER.html";
		CurrentPageTestCaseName = "Change from 1 to 2 bottle membership Immediately with MANAGER";
	...
	@Test
	public static void TC_0086_Regression_RUI_Changefrom1to2bottlemembershipImmediatelywithMANAGER()
