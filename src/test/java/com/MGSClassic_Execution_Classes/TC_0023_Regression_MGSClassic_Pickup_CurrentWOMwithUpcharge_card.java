...
public class TC_0023_Regression_MGSClassic_Pickup_CurrentWOMwithUpcharge_card {
	...
	public static void Beforetest() throws IOException, BiffException {
		...
		CurrentPageTestCaseName = "TC_0023_Regression_MGS_Pickup_CurrentWOMwithUpcharge_card";
	...
	@Test
	public static void TC_0023_Regression_MGS_Pickup_CurrentWOMwithUpcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_SelectWCCurrentWOMPickUPwithCharge(row);
