...
public class TC_0020_Regression_MGSClassic_Pickup_priorWOMwithNoupcharge_card {
	...
	@Test
	public static void TC_0020_Regression_MGS_Pickup_priorWOMwithNoupcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_SelectWCPriorWOMPickUP();
