...
public class TC_0033_Regression_MGSClassic_Change2to1BottleMembership_Immediately {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0033_Regression_MGSClassic_Change2to1BottleMembership_Immediately.html";
		CurrentPageTestCaseName = "TC_0033_Regression_MGSClassic_Change2to1BottleMembership_Immediately";
	...
	@Test
	public static void TC_0033_Regression_MGSClassic_Change2to1BottleMembership_Immediately()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changefrom2to1BottleImmediately(row);
