...
public class TC_0022_Regression_MGSClassic_Pickup_priorWOMwithUpcharge_card {
	...
	public static void TC_0023_Regression_MGS_Pickup_priorWOMwithUpcharge_card()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_SelectWCPriorWOMPickUPwithCharge(row);
