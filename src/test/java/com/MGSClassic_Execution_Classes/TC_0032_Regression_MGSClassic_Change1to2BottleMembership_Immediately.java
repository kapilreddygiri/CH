...
public class TC_0032_Regression_MGSClassic_Change1to2BottleMembership_Immediately {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0032_Regression_MGSClassic_Change1to2BottleMembership_Immediately.html";
		CurrentPageTestCaseName = "TC_0032_Regression_MGSClassic_Change1to2BottleMembership_Immediately";
	...
	@Test
	public static void TC_0032_Regression_MGSClassic_Change1to2BottleMembership_Immediately()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changefrom1to2BottleImmediately(row);
