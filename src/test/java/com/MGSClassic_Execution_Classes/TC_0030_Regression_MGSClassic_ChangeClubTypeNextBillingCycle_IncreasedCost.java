...
public class TC_0030_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_IncreasedCost {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0029_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_IncreasedCost.html";
		CurrentPageTestCaseName = "TC_0029_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_IncreasedCost";
	...
	@Test
	public static void TC_0029_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_IncreasedCost()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changeClubTypeIncreasedCostNextBillingCycle(row);
