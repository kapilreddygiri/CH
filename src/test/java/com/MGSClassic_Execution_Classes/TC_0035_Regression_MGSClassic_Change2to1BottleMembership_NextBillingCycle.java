...
public class TC_0035_Regression_MGSClassic_Change2to1BottleMembership_NextBillingCycle {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0035_Regression_MGSClassic_Change2to1BottleMembership_NextBillingCycle.html";
		CurrentPageTestCaseName = "TC_0035_Regression_MGSClassic_Change2to1BottleMembership_NextBillingCycle";
	...
	@Test
	public static void TC_0035_Regression_MGSClassic_Change2to1BottleMembership_NextBillingCycle()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changefrom2to1BottleNextBillingCycle(row);
