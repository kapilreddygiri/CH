...
public class TC_0029_Regression_MGSClassic_ChangeClubTypeImmediately_DecreasedCost {
	...
	public static void TC_0028_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_DecreasedCost()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changeClubTypeDecreasedCostImmediately();
