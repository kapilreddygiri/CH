...
public class TC_0037_Regression_MGSClassic_Add_Notes_NoteSection {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0037_Regression_MGSClassic_Add_Notes_NoteSection.html";
		CurrentPageTestCaseName = "TC_0037_Regression_MGSClassic_Add_Notes_NoteSection";
	...
	@Test
	public static void TC_0037_Regression_MGSClassic_Add_Notes_NoteSection()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_addNotes();
