...
public class TC_0028_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_DecreasedCost {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0028_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_DecreasedCost.html";
		CurrentPageTestCaseName = "TC_0028_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_DecreasedCost";
	...
	@Test
	public static void TC_0028_Regression_MGSClassic_ChangeClubTypeNextBillingCycle_DecreasedCost()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changeClubTypeDecreasedCostNextBillingCycle(row);
