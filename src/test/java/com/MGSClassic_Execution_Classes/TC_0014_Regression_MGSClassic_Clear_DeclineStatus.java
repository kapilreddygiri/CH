...
public class TC_0014_Regression_MGSClassic_Clear_DeclineStatus {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir")
				+ "\\Resources\\Reports\\TC_0014_Regression_MGS_Clear_DeclineStatus.html";
	...
	@Test
	public static void TC_0014_Regression_MGS_Clear_DeclineStatus()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_clearDeclineStatus();
