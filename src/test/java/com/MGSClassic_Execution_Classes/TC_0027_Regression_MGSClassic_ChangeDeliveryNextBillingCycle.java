...
public class TC_0027_Regression_MGSClassic_ChangeDeliveryNextBillingCycle {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0027_Regression_MGSClassic_ChangeDeliveryNextBillingCycle.html";
		CurrentPageTestCaseName = "TC_0027_Regression_MGSClassic_ChangeDeliveryNextBillingCycle";
	...
	@Test
	public static void TC_0027_Regression_MGSClassic_ChangeDeliveryNextBillingCycle()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_clickEditWCInfo();
				MGSPages.ClassicWCMemberValidationPage_changeDelivery();
				MGSPages.ClassicWCMemberValidationPage_nextBillingCycle();
				MGSPages.ClassicWCMemberValidationPage_clickProceedtoPaymentDetails();
