...
public class TC_0016_Regression_MGSClassic_Add_LoyaltyPoints {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0016_Regression_MGS_Add_LoyaltyPoints.html";
	...
	@Test
	public static void TC_0016_Regression_MGS_Add_LoyaltyPoints()
		...
		for (int row = 1; row < MonthlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_addLoyaltyPoints();
