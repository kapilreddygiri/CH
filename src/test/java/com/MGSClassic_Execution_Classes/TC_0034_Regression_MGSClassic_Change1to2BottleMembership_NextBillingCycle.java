...
public class TC_0034_Regression_MGSClassic_Change1to2BottleMembership_NextBillingCycle {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0034_Regression_MGSClassic_Change1to2BottleMembership_NextBillingCycle.html";
		CurrentPageTestCaseName = "TC_0034_Regression_MGSClassic_Change1to2BottleMembership_NextBillingCycle";
	...
	@Test
	public static void TC_0034_Regression_MGSClassic_Change1to2BottleMembership_NextBillingCycle()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changefrom1to2BottleNextBillingCycle(row); 
