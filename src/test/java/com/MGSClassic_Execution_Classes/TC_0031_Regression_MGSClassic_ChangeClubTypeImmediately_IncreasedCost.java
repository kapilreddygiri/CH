...
public class TC_0031_Regression_MGSClassic_ChangeClubTypeImmediately_IncreasedCost {
	...
	public static void Beforetest() throws IOException, BiffException {
		HTMLReportPAth = System.getProperty("user.dir") + "\\Resources\\Reports\\TC_0031_Regression_MGSClassic_ChangeClubTypeImmediately_IncreasedCost.html";
		CurrentPageTestCaseName = "TC_0031_Regression_MGSClassic_ChangeClubTypeImmediately_IncreasedCost";
	...
	@Test
	public static void TC_0031_Regression_MGSClassic_ChangeClubTypeImmediately_IncreasedCost()
		...
		for (int row = 1; row < MothlyMemberData.GetRows(); row++) {
			...
			try {
				...
				MGSPages.ClassicWCMemberValidationPage_changeClubTypeIncreasedCostImmediately();
