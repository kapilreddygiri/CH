package com.Restaurant.PageData;
...
public class Restaurant_SignUpPagedata {
	private static ExcelConnection testData = null;

	public Restaurant_SignUpPagedata() {

	}

	public Restaurant_SignUpPagedata(String ExcelPath, String sheetname, String WritalPath) {
